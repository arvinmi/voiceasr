...
$TaskName = "VoiceASR"
$HuggingFaceCache = Join-Path $HOME ".cache\huggingface\hub"
$MedASRCache = Join-Path $HuggingFaceCache "models--google--medasr"
$MedASRLockCache = Join-Path $HuggingFaceCache ".locks\models--google--medasr"
...
Remove-Item -Path $MedASRCache -Recurse -Force -ErrorAction SilentlyContinue
Remove-Item -Path $MedASRLockCache -Recurse -Force -ErrorAction SilentlyContinue
